...
Choose your cloud provider and use the provided Terraform configurations located in `deploy/terraform/` to set up the VPC, Kubernetes cluster, and high-performance SSD storage class.
